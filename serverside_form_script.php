...
<head>
 <meta charset="UTF-8">
 <title>IDX-519 Lab 3 Form Processing Script</title>
  <style>
    .box {
...
<body>
 <div style="text-align:center;">
  <h2>IDX-519 Lab 3 Form Processing Script</h2>
  <p>This page will display the results of the form that was submitted to it.</p>
 </div>
 <hr><br>
 <h1>Thank you for your IDX-519 form submission, <?php echo htmlentities($firstName) ?>!</h1>
 <div class="box">
